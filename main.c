   ...
   if (strcmp(argv[3],"avl")==0)mode=AVL_MODE;
    ...
    if(strcmp(argv[4],"t1")==0){
        ...
        case AVL_MODE:
            ...
            break;
        case BST_MODE:
            Tree* bst=readLinesBST(file,readLinesBST,compareStationID,minTemperatureMin);
        ...
        case AVL_MODE:
            ...
            break;
        case BST_MODE:
            Tree* bst=readLinesBST(file,readLinesBST,compareDate,minTemperatureMin);
        ...
        case AVL_MODE:
            ...
            break;
        case BST_MODE:
            Tree* bst=readLinesBST(file,readLinesBST,compareDateThenStation,minTemperatureMin);
        ...
        case AVL_MODE:
            ...
            break;
        case BST_MODE:
            Tree* bst=readLinesBST(file,readLinesBST,compareStationID,minStationPressure);
        ...
        case AVL_MODE:
            ...
            break;
        case BST_MODE:
            Tree* bst=readLinesBST(file,readLinesBST,compareDate,minStationPressure);
        ...
        case AVL_MODE:
            ...
            break;
        case BST_MODE:
            Tree* bst=readLinesBST(file,readLinesBST,compareDateThenStation,minStationPressure);
